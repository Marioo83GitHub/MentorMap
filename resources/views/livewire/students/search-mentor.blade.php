<div>
    ...
    <div class="relative h-screen w-screen overflow-hidden">
        ...
        <a href="{{ route('students.dashboard') }}"
            class="fixed top-2 md:top-6 left-2 md:left-16 z-50 inline-flex items-center space-x-2 bg-white/75 dark:bg-gray-800/90 backdrop-blur-sm text-gray-700 dark:text-gray-300 hover:text-gray-900 dark:hover:text-white font-medium py-2 md:py-2.5 px-3 md:px-4 rounded-xl shadow-lg hover:shadow-xl border border-gray-200 dark:border-gray-600 transition-all duration-200">
            <svg class="w-4 h-4" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M10 19l-7-7m0 0l7-7m-7 7h18" />
            </svg>
            <span class="text-xs md:text-sm">Volver a Inicio</span>
        </a>

        <!-- Panel Lateral Flotante - Responsive -->
        <div
            class="fixed inset-x-2 top-12 bottom-2 md:right-6 md:top-6 md:bottom-6 md:left-auto md:w-md z-40 flex flex-col">
            <div
                ...
                <div class="p-4 md:p-6 border-b border-gray-200 dark:border-gray-700 bg-white dark:bg-gray-800">
                    <div class="flex items-center space-x-3 mb-3 md:mb-4">
                        ...
                        <div>
                            ...
                            <p class="text-xs md:text-sm text-gray-600 dark:text-gray-400">Encuentra el mentor perfecto
                            </p>
                        </div>
                    </div>
                    ...
                    <div class="space-y-3 md:space-y-4">
                        ...
                        <div wire:ignore class="space-y-2">
                            ...
                            <input wire:model="distanceRange" type="range" id="radiusInput" min="200"
                                max="30000" value="1000" step="100"
                        ...
                        <div class="flex gap-4">
                            ...
                            <button wire:click="$js.search"
                                ...
                                <span class="text-xs md:text-sm">Buscar Aquí</span>
                            </button>
                        </div>
        ...
        @if ($selectedMentorId)
            ...
            <div
                class="fixed inset-0 bg-black/60 backdrop-blur-sm flex items-center justify-center z-[9999] p-2 md:p-4">
                <div
                                ...
                                <div>
                                    ...
                                    <div class="flex items-center space-x-2 mt-1">
                                        <div class="flex text-yellow-300">
                                            @for ($i = 1; $i <= 5; $i++)
                                                @php
                                                    $rating = $selectedMentor->average_rating;
                                                    $isFullStar = $i <= floor($rating);
                                                    $isHalfStar =
                                                        !$isFullStar &&
                                                        $i <= ceil($rating) &&
                                                ...
                                                @if ($isFullStar)
                                                    {{-- Estrella completa --}}
                                                    <svg class="w-3 md:w-4 h-3 md:h-4 text-yellow-300 fill-current"
                                                        viewBox="0 0 20 20">
                                                        <path
                                                            d="M9.049 2.927c.3-.921 1.603-.921 1.902 0l1.07 3.292a1 1 0 00.95.69h3.462c.969 0 1.371 1.24.588 1.81l-2.8 2.034a1 1 0 00-.364 1.118l1.07 3.292c.3.921-.755 1.688-1.54 1.118l-2.8-2.034a1 1 0 00-1.175 0l-2.8 2.034c-.784.57-1.838-.197-1.539-1.118l1.07-3.292a1 1 0 00-.364-1.118L2.98 8.72c-.783-.57-.38-1.81.588-1.81h3.461a1 1 0 00.951-.69l1.07-3.292z" />
                                                    </svg>
                                                @elseif ($isHalfStar)
                                                    {{-- Media estrella --}}
                                                    <div class="relative inline-block w-3 md:w-4 h-3 md:h-4">
                                                        {{-- Estrella vacía de fondo --}}
                                                        <svg class="absolute inset-0 text-white/30 fill-current"
                                                            viewBox="0 0 20 20">
                                                            <path
                                                                d="M9.049 2.927c.3-.921 1.603-.921 1.902 0l1.07 3.292a1 1 0 00.95.69h3.462c.969 0 1.371 1.24.588 1.81l-2.8 2.034a1 1 0 00-.364 1.118l1.07 3.292c.3.921-.755 1.688-1.54 1.118l-2.8-2.034a1 1 0 00-1.175 0l-2.8 2.034c-.784.57-1.838-.197-1.539-1.118l1.07-3.292a1 1 0 00-.364-1.118L2.98 8.72c-.783-.57-.38-1.81.588-1.81h3.461a1 1 0 00.951-.69l1.07-3.292z" />
                                                        </svg>
                                                        ...
                                                        <div class="absolute inset-0 overflow-hidden"
                                                            style="width: 50%;">
                                                            <svg class="text-yellow-300 fill-current"
                                                                viewBox="0 0 20 20" style="width: 200%;">
                                                                <path
                                                                    d="M9.049 2.927c.3-.921 1.603-.921 1.902 0l1.07 3.292a1 1 0 00.95.69h3.462c.969 0 1.371 1.24.588 1.81l-2.8 2.034a1 1 0 00-.364 1.118l1.07 3.292c.3.921-.755 1.688-1.54 1.118l-2.8-2.034a1 1 0 00-1.175 0l-2.8 2.034c-.784.57-1.838-.197-1.539-1.118l1.07-3.292a1 1 0 00-.364-1.118L2.98 8.72c-.783-.57-.38-1.81.588-1.81h3.461a1 1 0 00.951-.69l1.07-3.292z" />
                                                            </svg>
                                                        </div>
                                                ...
                                                @else
                                                    {{-- Estrella vacía --}}
                                                    <svg class="w-3 md:w-4 h-3 md:h-4 text-white/30 fill-current"
                                                        viewBox="0 0 20 20">
                                                        <path
                                                            d="M9.049 2.927c.3-.921 1.603-.921 1.902 0l1.07 3.292a1 1 0 00.95.69h3.462c.969 0 1.371 1.24.588 1.81l-2.8 2.034a1 1 0 00-.364 1.118l1.07 3.292c.3.921-.755 1.688-1.54 1.118l-2.8-2.034a1 1 0 00-1.175 0l-2.8 2.034c-.784.57-1.838-.197-1.539-1.118l1.07-3.292a1 1 0 00-.364-1.118L2.98 8.72c-.783-.57-.38-1.81.588-1.81h3.461a1 1 0 00.951-.69l1.07-3.292z" />
                                                    </svg>
                                        ...
                                        <span class="text-white/90 text-xs md:text-sm">
                                            {{ number_format($selectedMentor->average_rating, 1) }} rating •
                                            {{ $selectedMentor->finalized_sessions }} sesiones completadas
                                        </span>
                                    </div>
                                </div>
                            </div>
                            ...
                            <div class="space-y-4">
                                ...
                                <div class="grid grid-cols-1 sm:grid-cols-2 gap-3 md:gap-4">
                                    ...
                                    <div class="bg-blue-50 dark:bg-blue-900/20 rounded-xl p-3 md:p-4 text-center">
                                        ...
                                        <div class="text-xs md:text-sm text-gray-600 dark:text-gray-400">sesiones
                                            completadas</div>
                                    </div>
                                </div>
                            </div>
                                ...
                                <div class="max-h-80 overflow-y-auto space-y-3 custom-scrollbar">
                                    ...
                                    @else
                                        <div class="bg-gray-50 dark:bg-gray-700 rounded-xl p-6 text-center">
                                            ...
                                            <p class="text-gray-500 dark:text-gray-400">Este mentor no tiene materias
                                                asignadas</p>
                                        </div>
                                    @endif
                                </div>
                    ...
                    <div
                        class="bg-gray-50 dark:bg-gray-700 px-4 md:px-6 py-3 md:py-4 border-t border-gray-200 dark:border-gray-600">
                        <div class="flex flex-col sm:flex-row justify-between items-center space-y-3 sm:space-y-0">
                            <div class="text-xs md:text-sm text-gray-500 dark:text-gray-400 text-center sm:text-left">
                                Mentor desde: <span
                                    class="font-medium">{{ $selectedMentor->created_at->format('M Y') }}</span>
                            </div>
...
<script>
    ...
    function updateCoordinates(lat, lng) {
        currentLat = lat;
        currentLng = lng;
        if (latLabel) latLabel.textContent = `${lat.toFixed(6)}`;
        if (lngLabel) lngLabel.textContent = `${lng.toFixed(6)}`;
    }
    updateCoordinates(currentLat, currentLng);

    // AQUÍ ESTÁ LA CORRECCIÓN: Usar 'dragend' en lugar de 'move'
    marker.on("dragend", (e) => {
        const {
            lat,
            lng
        } = e.target.getLatLng();
        circle.setLatLng([lat, lng]); // Actualizar posición del círculo
        updateCoordinates(lat, lng);
    });

    // También mantener el evento 'drag' para actualización en tiempo real (opcional)
    marker.on("drag", (e) => {
        const {
            lat,
            lng
        } = e.target.getLatLng();
        circle.setLatLng([lat, lng]); // Actualizar posición del círculo en tiempo real
        updateCoordinates(lat, lng);
    });
