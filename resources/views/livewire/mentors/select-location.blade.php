...
<div class="flex flex-col lg:flex-row min-h-screen gap-4 p-4 relative z-10 transition-colors duration-300">
    ...
    <!-- Map Container -->
    <!-- Mobile Header -->
    <div class="lg:hidden sm:block bg-white dark:bg-gray-800 rounded-2xl shadow-xl border border-gray-200 dark:border-gray-700 p-4">
        <div class="flex items-center space-x-3">
            <div class="w-10 h-10 bg-green-100 dark:bg-green-900 rounded-full flex items-center justify-center">
                <svg class="w-5 h-5 text-mmgreen dark:text-mmgreen" fill="none" stroke="currentColor" viewBox="0 0 24 24">
    ...
    <div class="relative order-1 lg:order-1 lg:w-3/5">
        <div id="map" class="w-full h-80 lg:h-full min-h-[320px] rounded-2xl shadow-lg border border-gray-200 dark:border-gray-700"></div>
    </div>

    <!-- Controls Panel -->
    <div class="order-2 lg:order-2 lg:w-2/5 bg-white dark:bg-gray-800 rounded-2xl shadow-xl border border-gray-200 dark:border-gray-700 transition-colors duration-300">
        
        <!-- Header -->
        <div class="p-6 border-b border-gray-100 dark:border-gray-700">
            <h2 class="text-2xl font-bold text-gray-900 dark:text-white mb-1">¿Dónde te encuentras?</h2>
            <p class="text-gray-600 dark:text-gray-300 text-sm">Esta información nos ayudará a conectarte con estudiantes cercanos</p>
        </div>
        ...
        <div class="p-6 space-y-6">
            ...
            <div class="bg-gray-50 dark:bg-gray-700/50 rounded-xl p-4 space-y-2 transition-colors duration-300">
                <h3 class="font-semibold text-gray-700 dark:text-gray-200 text-sm uppercase tracking-wide">Coordenadas Seleccionadas</h3>
                <div class="grid grid-cols-1 sm:grid-cols-2 gap-3">
                    <div class="bg-white dark:bg-gray-800 rounded-lg p-3 border border-gray-200 dark:border-gray-600 transition-colors duration-300">
                        <div class="text-xs text-gray-500 dark:text-gray-400 mb-1">Latitud</div>
                        <div id="latitudeLabel" class="font-mono text-sm font-medium text-gray-800 dark:text-gray-100">--</div>
                    </div>
                    <div class="bg-white dark:bg-gray-800 rounded-lg p-3 border border-gray-200 dark:border-gray-600 transition-colors duration-300">
                        <div class="text-xs text-gray-500 dark:text-gray-400 mb-1">Longitud</div>
                        <div id="longitudeLabel" class="font-mono text-sm font-medium text-gray-800 dark:text-gray-100">--</div>
                    </div>
                </div>
            </div>

            <!-- Privacy Notice -->
            <div class="bg-blue-50 dark:bg-blue-900/30 border border-blue-200 dark:border-blue-700 rounded-xl p-4 transition-colors duration-300">
                <div class="flex items-start gap-3">
                    ...
                    <div>
                        ...
                        <p class="text-blue-700 dark:text-blue-200 text-xs mt-1">Tu ubicación exacta será aproximada por seguridad. Solo se mostrará un área general a los estudiantes.</p>
                    </div>
                </div>
            </div>
            ...
            <div class="space-y-3">
                ...
                <p class="text-xs text-gray-500 dark:text-gray-400 text-center">La detección de ubicación puede tardar unos segundos</p>
        ...
        $wire.on('getLocation', () => {
            ...
            navigator.geolocation.getCurrentPosition(
                (position) => {
                    ...
                    marker.setLatLng([lat, lng])
                        .bindPopup(createPopup('📍', 'Tu Ubicación', 'Ubicación detectada exitosamente', 'text-mmgreen dark:text-green-400'))
                        .openPopup();
