                ...
                <div class="p-6 bg-white rounded-lg shadow-md dark:bg-gray-800 dark:border dark:border-gray-700">
                    <div class="flex justify-between items-start">
                        ...
                        <span class="px-3 py-1 text-xs font-semibold rounded-full capitalize
                            @if($appointment->status == 'scheduled') bg-blue-100 text-blue-800 dark:bg-blue-900 dark:text-blue-300 @endif
                            @if($appointment->status == 'completed') bg-green-100 text-green-800 dark:bg-green-900 dark:text-green-300 @endif
                            @if($appointment->status == 'canceled') bg-red-100 text-red-800 dark:bg-red-900 dark:text-red-300 @endif
                        ">
                    ...
                    <div class="mt-4 border-t border-gray-200 dark:border-gray-700 pt-4">
                        <p class="text-sm text-gray-600 dark:text-gray-400">
                            <span class="font-semibold">Fecha:</span> {{ \Carbon\Carbon::parse($appointment->scheduled_at)->format('d/m/Y \a \l\a\s H:i') }}
                        </p>
