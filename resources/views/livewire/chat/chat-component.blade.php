                        ...
                        <div class="flex items-center">
                            ...
                            <div class="ml-3">
                                <p class="text-lg font-semibold">
                                    {{ $selectedConversation->getOtherParticipant()->name . ' ' . $selectedConversation->getOtherParticipant()->surname}}</p>
                            </div>
                        </div>
                            ...
                            <div class="relative w-full">
                                <form wire:submit.prevent="sendMessage">
                                    <input type="text" wire:model.defer="newMessage"
                                        class="flex w-full rounded-xl focus:outline-none focus:border-indigo-300 pl-4 h-10"
